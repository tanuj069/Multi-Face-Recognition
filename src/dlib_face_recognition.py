...
def multi_frame_face_recognition(frames_buffer, frame_downsample=True, model='hog',
    ...
    while True:
        ...
        if ret:
            ...
            yield from single_frame_face_recognition(
                frame=img0,
...
def batched_frame_face_recognition(frames_buffer):
    """
    This function is to be used for GPU based face recognition. It performs face detection on a batch of frames at a
    time.
            ...
            for _, current_face_encoding in zip(all_face_locations_single_frame, all_face_encodings_single_frame):
                ...
                if all_matches[best_match_index] <= FACE_MATCHING_TOLERANCE:
                    ...
                    store_inferred_face_in_dataframe(
                        name_of_person,
                        all_matches[best_match_index],
                        batch_of_cam_names[i],
                        batch_of_cam_ips[i]
                    )
