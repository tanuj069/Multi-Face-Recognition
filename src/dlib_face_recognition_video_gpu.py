...
from parameters import FILES_PATH, NUMBER_OF_TIMES_TO_UPSAMPLE, FRAME_WIDTH, FRAME_HEIGHT
...
while True:
    ...
    if ret:
        ...
        # resize frame to FRAME_WIDTH x FRAME_HEIGHT to display the video if frame is too big
...
output_video = cv2.VideoWriter(FILES_PATH + 'output_video.avi', cv2.VideoWriter_fourcc(*'DIVX'), 15,
